...
st.title(""🤖 Asistente de Intercambio de Semillas"")
...
if ""messages"" not in st.session_state:
    st.session_state.messages = [
        {""role"": ""assistant"", ""content"": ""👋 Hello! I am your virtual assistant. How can I help you today? Feel free to use the quick buttons below or type a question!""}
    ]
